...
export const environment = {
  ...
  applyFiltersUrl: 'http://localhost:5000/public/applyfilter/',
  booksUrl: 'http://localhost:5000/model/book/',
  addBookUrl: 'http://localhost:5000/model/book/add',
  getBook: 'http://localhost:5000/model/book/',
