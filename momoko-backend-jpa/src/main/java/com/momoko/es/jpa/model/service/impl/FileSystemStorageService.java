...
import com.momoko.es.jpa.model.service.impl.util.FileSystemStorageFactory;
...
public class FileSystemStorageService implements StorageService {
     ...
     */
    @Override
    public AnchuraAlturaDTO getImageDimensions(String filename, final String tipoAlmacenamiento) throws IOException {
        if (filename.contains(" ")) {
