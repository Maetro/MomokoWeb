...
public class GuardarLibroResponse implements Serializable {
    ...
    /** The estado guardado. */
    EstadoGuardadoLibroEnum estadoGuardado;
     ...
     */
    public EstadoGuardadoLibroEnum getEstadoGuardado() {
     ...
     */
    public void setEstadoGuardado(final EstadoGuardadoLibroEnum estadoGuardado) {
