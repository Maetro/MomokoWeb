...
import com.momoko.es.api.exceptions.security.domain.ChangePasswordForm;
import com.momoko.es.api.exceptions.security.domain.ResetPasswordForm;
...
public class MomokoController <U extends AbstractUser<U,ID>, ID extends Serializable> {
