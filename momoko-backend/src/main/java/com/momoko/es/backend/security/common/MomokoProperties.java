package com.momoko.es.backend.security.common;
...
public class MomokoProperties {

    private static final Log log = LogFactory.getLog(MomokoProperties.class);

    public MomokoProperties() {
        log.info("MomokoProperties Created");
    }
    /**
